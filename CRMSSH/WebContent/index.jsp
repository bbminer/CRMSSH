			...
			<div class="layui-main">
				<div class="admin-login-box">
					<a class="logo" style="left: 0;" href=""> <span
						style="font-size: 22px;">客户关系管理系统</span>
					</a>
				...
				<ul class="layui-nav admin-header-item">
					<li class="layui-nav-item"><a href="javascript:;"
						class="admin-header-user"> <img src="images/0.jpg" /> <span>${user.userName}</span>
					</a>
			...
			<div class="layui-tab admin-nav-card layui-tab-brief"
				...
				<div class="layui-tab-content"
					...
					<div class="layui-tab-item layui-show">
						<iframe src="${pageContext.request.contextPath}/main.html"></iframe>
					</div>
				</div>
			</div>
		</div>
